...
import { Container, Typography, Card, CardMedia, CardActionArea, Grid, Box, Pagination } from "@mui/material";
            ...
            <Card sx={{ position: "relative", borderRadius: 3, overflow: "hidden", height: "100%" }}>
              ...
              >
                <CardMedia
                  component="img"
                  height="100%"
                  image={getImageUrl(displayedNews[0].media_url)}
                ...
                >
                  ...
                  <Typography variant="body2">
                    {getRelativeTime(displayedNews[0].pub_date || displayedNews[0].created_at)} · {displayedNews[0].source}
                  </Typography>
                </Box>
              </CardActionArea>
            </Card>
            ...
            >
              ...
              <Box>
                ...
                <Typography variant="body2" color="gray">
                  {getRelativeTime(article.pub_date || article.created_at)} · {article.source}
                </Typography>
              </Box>
            </CardActionArea>
          ))}
